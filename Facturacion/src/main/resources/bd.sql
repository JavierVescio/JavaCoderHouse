...
--
-- Host: localhost
-- Generation Time: Feb 13, 2024 at 04:45 PM
...
INSERT INTO `cliente` (`id`, `activo`, `email`, `nombre`, `apellido`) VALUES
(1, 1, 'leonardotamburello@gmail.com', 'Leonardo', '');
...
(1, 'Samsung J5 2016', 50000, 20),
(2, 'Sony Xperia U', 20000, 3),
(3, 'Moto G13', 180000, 64);
...
INSERT INTO `venta` (`id`, `fecha`, `cliente_id`, `confirmada`, `precio_total`) VALUES
(1, NULL, NULL, 0, 0),
(2, NULL, NULL, 0, 0);
